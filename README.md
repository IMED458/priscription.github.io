...
<head>
  ...
  <style>
    ...
    .patient-name-print { font-size: 26px; font-weight: bold; color: #1e40af; text-align: center; margin: 15px 0; padding: 10px; background: #f0f8ff; border-bottom: 3px solid #3b82f6; }
...
<div class="container">
  ...
  <!-- პაციენტის სახელი გვარი (საბეჭდად) -->
  ...
  <!-- ========== გვერდი 1 - პასპორტი + მედიკამენტები ========== -->
  <div class="page active" id="page-1">
    <div class="section">
      <div class="info-grid">
        ...
        <div class="input-group"><label>შემოსვლის თარიღი</label><input type="date" id="admissionDate"></div>
        <div class="input-group"><label>დღევანდელი თარიღი</label><input type="date" id="currentDate"></div>
  ...
  <div class="page" id="page-2">
    ...
    <div class="signature">
      <div style="text-align: center;">
        ...
        <p style="margin-top: 10px; font-weight: 600;">ექიმის ხელმოწერა</p>
      </div>
      <div style="text-align: center;">
        <div class="sig-line"></div>
        <p style="margin-top: 10px; font-weight: 600;">ექთნის ხელმოწერა</p>
      </div>
    </div>
  </div>
</div>
